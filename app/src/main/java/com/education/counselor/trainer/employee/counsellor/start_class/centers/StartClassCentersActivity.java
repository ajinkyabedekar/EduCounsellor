package com.education.counselor.trainer.employee.counsellor.start_class.centers;
...
public class StartClassCentersActivity extends AppCompatActivity {
    RecyclerView recyclerView;
    DatabaseReference db;
    StartClassCentersEntryAdapter adapter;
    ProgressBar pg;
    Context mContext;
    private ArrayList<StartClassCentersEntryVo> details = new ArrayList<>();
    String access, email;
    boolean flag = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start_class_centers);
        mContext = this;
        ...
        db.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    StartClassCentersEntryVo s = new StartClassCentersEntryVo();
                ...
                adapter = new StartClassCentersEntryAdapter(mContext, details);
