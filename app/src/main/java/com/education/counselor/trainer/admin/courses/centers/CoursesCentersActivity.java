...
public class CoursesCentersActivity extends AppCompatActivity {
    RecyclerView recyclerView;
    DatabaseReference db;
    CoursesCentersEntryAdapter adapter;
    ProgressBar pg;
    Context mContext;
    private ArrayList<CoursesCentersEntryVo> details = new ArrayList<>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_courses_centers);
        mContext = this;
