...
import com.education.counselor.trainer.authority.college.live_chat.liveChatAdmin.CollegeAdminLiveChat;
import com.education.counselor.trainer.authority.college.live_chat.liveChatCounsellor.CollegeCounsellorLiveChat;
import com.education.counselor.trainer.authority.college.live_chat.liveChatTrainer.CollegeTrainerLiveChat;
...
public class ListEntryAdapter extends RecyclerView.Adapter<List> {
    ...
    public void onBindViewHolder(@NonNull final List holder, final int i) {
        DatabaseReference db = FirebaseDatabase.getInstance().getReference("college_authority");
