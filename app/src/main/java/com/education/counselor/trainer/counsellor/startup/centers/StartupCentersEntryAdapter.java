package com.education.counselor.trainer.counsellor.startup.centers;
...
public class StartupCentersEntryAdapter extends RecyclerView.Adapter<StartupCenters> {
    ...
    public StartupCenters onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(c).inflate(R.layout.layout_startup_centers_adapter2, viewGroup, false);
