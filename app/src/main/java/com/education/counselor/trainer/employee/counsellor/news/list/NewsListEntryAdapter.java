package com.education.counselor.trainer.employee.counsellor.news.list;
...
import com.education.counselor.trainer.employee.counsellor.news.NewsDetailsActivity;
...
public class NewsListEntryAdapter extends RecyclerView.Adapter<NewsList> {
    ...
    public NewsList onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(c).inflate(R.layout.layout_news_list_adapter2, viewGroup, false);
