package com.education.counselor.trainer.employee.trainer.internship;
...
import com.education.counselor.trainer.employee.trainer.internship.list.InternshipListActivity;
...
public class InternshipDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_internship_details3);
        Intent i = getIntent();
        if (i.hasExtra("name")) {
