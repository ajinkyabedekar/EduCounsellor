package com.education.counselor.trainer.admin.reviews;
...
public class GreaterThanThreeActivity extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_greater_than_three);
    }
