package com.education.counselor.trainer.counsellor.news.centers;
...
public class NewsCentersActivity extends AppCompatActivity {
    ...
    NewsCentersEntryAdapter adapter;
    ProgressBar pg;
    Context mContext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_news_centers2);
        mContext = this;
        ...
        db.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    NewsCentersEntryVo s = new NewsCentersEntryVo();
