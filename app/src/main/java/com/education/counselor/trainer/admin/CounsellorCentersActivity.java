...
public class CounsellorCentersActivity extends AppCompatActivity {
    ...
    EditText name;
    CounsellorCentersEntryAdapter adapter;
    ProgressBar pg;
    Context mContext;
    private ArrayList<CounsellorCentersEntryVo> details = new ArrayList<>();
        ...
        db.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    CounsellorCentersEntryVo s = new CounsellorCentersEntryVo();
                    s.setName(Objects.requireNonNull(ds.child("name").getValue()).toString());
                    details.add(s);
                }
                adapter = new CounsellorCentersEntryAdapter(mContext, details);
