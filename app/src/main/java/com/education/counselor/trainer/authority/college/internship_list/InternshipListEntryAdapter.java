package com.education.counselor.trainer.authority.college.internship_list;
...
public class InternshipListEntryAdapter extends RecyclerView.Adapter<InternshipList> {
    ...
    public InternshipList onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(c).inflate(R.layout.layout_internship_list_adapter2, viewGroup, false);
