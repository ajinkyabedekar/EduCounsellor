package com.education.counselor.trainer.admin.startup;
...
public class AddStartupActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    EditText name, department, startup, package_name, location, student;
    Button submit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (name.getText().toString().equals("")) {
                ...
                } else if (startup.getText().toString().equals("")) {
                    startup.requestFocus();
                    startup.setError("This Is A Required Field");
                    ...
                    myRef.child("company").setValue(startup.getText().toString());
