package com.education.counselor.trainer.employee.counsellor.placement.list;
...
import com.education.counselor.trainer.employee.counsellor.placement.PlacementDetailsActivity;
...
public class PlacementListEntryAdapter extends RecyclerView.Adapter<PlacementList> {
    ...
    public PlacementList onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(c).inflate(R.layout.layout_placement_list_adapter4, viewGroup, false);
