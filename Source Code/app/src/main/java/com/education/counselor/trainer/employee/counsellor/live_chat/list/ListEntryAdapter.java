package com.education.counselor.trainer.employee.counsellor.live_chat.list;
...
import com.education.counselor.trainer.employee.counsellor.live_chat.collegeliveChat.collegeChat;
import com.education.counselor.trainer.employee.counsellor.live_chat.liveChatAdmin.adminLiveChat;
import com.education.counselor.trainer.employee.counsellor.live_chat.schoolLiveChat.schoolAdminChat;
            ...
            public void onClick(View v) {
                ...
                switch (name) {
                    case "college_authority":
                        c.startActivity(new Intent(c, collegeChat.class).putExtra("key", receiverKey).putExtra("user", user).putExtra("senderKey", senderKey));
                        break;
                    case "admin":
                        c.startActivity(new Intent(c, adminLiveChat.class).putExtra("key", receiverKey).putExtra("user", user).putExtra("senderKey", senderKey));
                        break;
