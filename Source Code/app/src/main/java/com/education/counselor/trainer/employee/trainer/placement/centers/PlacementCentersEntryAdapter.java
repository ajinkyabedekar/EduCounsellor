package com.education.counselor.trainer.employee.trainer.placement.centers;
...
import com.education.counselor.trainer.employee.trainer.placement.list.PlacementListActivity;
...
public class PlacementCentersEntryAdapter extends RecyclerView.Adapter<PlacementCenters> {
    ...
    public PlacementCenters onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(c).inflate(R.layout.layout_placement_centers_adapter2, viewGroup, false);
